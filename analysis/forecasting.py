...
file_path = "/mnt/data/sales_data_1year.xlsx"  # Example filename
df = pd.read_excel(file_path)

# Rename for Prophet
df.rename(columns={"date": "ds", "total_order": "y", "product": "product_name"}, inplace=True)
...
for product in df["product_name"].unique():
    ...
    seasonal_strength = forecast["seasonal"].std()
